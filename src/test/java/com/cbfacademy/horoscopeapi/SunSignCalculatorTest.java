...
class SunSignCalculatorTest {
    ...
    void signsCorrect() {
        assertEquals("Aries", SunSignCalculator.byDate(LocalDate.parse("2024-04-01")), "Expected Aries for 2024-04-01");
        ...
        assertEquals("Leo", SunSignCalculator.byDate(LocalDate.parse("2024-08-01")), "Expected Leo for 2024-08-01");
        assertEquals("Virgo", SunSignCalculator.byDate(LocalDate.parse("2024-09-01")), "Expected Virgo for 2024-09-01");
        assertEquals("Libra", SunSignCalculator.byDate(LocalDate.parse("2024-10-01")), "Expected Libra for 2024-10-01");
    ...
    void boundaries() {
        ...
        assertEquals("Aries", SunSignCalculator.byDate(LocalDate.parse("2024-03-21")), "Expected Aries for 2024-03-21");

        // Aries → Taurus
        assertEquals("Aries", SunSignCalculator.byDate(LocalDate.parse("2024-04-19")), "Expected Aries for 2024-04-19");
        ...
        assertEquals("Leo", SunSignCalculator.byDate(LocalDate.parse("2024-07-23")), "Expected Leo for 2024-07-23");

        // Leo → Virgo
        assertEquals("Leo", SunSignCalculator.byDate(LocalDate.parse("2024-08-22")), "Expected Leo for 2024-08-22");
        assertEquals("Virgo", SunSignCalculator.byDate(LocalDate.parse("2024-08-23")), "Expected Virgo for 2024-08-23");

        // Virgo → Libra
        assertEquals("Virgo", SunSignCalculator.byDate(LocalDate.parse("2024-09-22")), "Expected Virgo for 2024-09-22");
        assertEquals("Libra", SunSignCalculator.byDate(LocalDate.parse("2024-09-23")), "Expected Libra for 2024-09-23");

        // Libra → Scorpio
        assertEquals("Libra", SunSignCalculator.byDate(LocalDate.parse("2024-10-22")), "Expected Libra for 2024-10-22");
